...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing tivimatee2_1.0.03      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/068/refs/heads/main/enigma2-plugin-extensions-tivimatee2_1.0.03_all.ipk"
IPK_NAME="enigma2-plugin-extensions-tivimatee2_1.0.03_all.ipk"
